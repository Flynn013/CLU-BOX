...
constructor(
  ...
  fun getSystemPrompt(baseSystemPrompt: String, toolsSummary: String = ""): Contents {
    // Replace ___SKILLS___ with the selected skill names/descriptions, and
    // ___TOOLS___ with the native tool catalog generated by AgentTools.
    val selectedSkillsNamesAndDescriptions = getSelectedSkillsNamesAndDescriptions()
    val systemPrompt = baseSystemPrompt
      .replace("___TOOLS___", toolsSummary)
